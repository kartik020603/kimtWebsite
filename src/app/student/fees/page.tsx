...
export default async function StudentFeesPage() {
    ...
    const stats = [
        { label: "Total Committed", value: `₹${studentData.totalFees.toLocaleString()}`, icon: Sparkles, color: "text-indigo-600" },
            ...
            <div className="bg-indigo-900 p-10 rounded-[3rem] text-white relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="space-y-4">
                        <div className="bg-white/10 w-fit px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest text-indigo-200">Payment Deadline</div>
                    ...
                    <div className="text-center md:text-right">
                        <p className="text-indigo-200 text-sm font-medium mb-4 max-w-xs ml-auto">Please ensure timely payments to maintain access to your study materials and certificates.</p>
                        <button className="bg-white text-indigo-900 font-black px-10 py-4 rounded-2xl shadow-2xl hover:bg-gray-100 transition-all hover:scale-105 active:scale-95">
                            Contact Admin
                        </button>
                    </div>
                </div>
